        ...
        (setScore, setPhase) => (
          <div className={styles['game-container']}>
            ...
            <div className="buttons-field">
              {!isFinish && <button onClick={() => { setIsFinish(true) }} disabled={!isAllanswered}>{myData.btnNext}</button>}
              {isFinish && <button onClick={() => { handleFinish(setPhase, setScore) }}>{myData.btnAnswer}</button>}
            </div>
          </div>
        )
      }
