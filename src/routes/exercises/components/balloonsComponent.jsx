  ...
  return (
    <>
      <div>
        <svg className="svg-game" onClick={makeDraggable} viewBox="0 0 450 450" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(480.04, 30.9686)" id="rect-os">
            ...
            <text x="38%" y="9%" textAnchor="middle" fill="#E0E0E0" fontSize="90%" fontFamily="Montserrat" dy=".3em" fontWeight="bold">{data.system}</text>
          </g>
          {
      ...
      <div className="buttonsContainer">
        {
          !isFinish
            ? <button id="buttonFinish" onClick={getBalloonsFinalPositions}>{data.btnEnd}</button>
            : <button id="buttonFinish" onClick={() => {
              setPhase('end')
              setScore(sco)
            }}>{data.btnNext}</button>
        }
