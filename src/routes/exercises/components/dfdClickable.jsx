  ...
  if (process == 'arrowLeftYes') {
    return (
      <svg width="65%" height="100%" viewBox="0 0 43 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="50%" textAnchor="middle" fill="#FFFFFF" fontSize="90%" fontFamily="Montserrat" dy=".3em" fontWeight="bold">{text}</text>
      </svg>
  ...
  if (process == 'arrowDownNo') {
    return (
      <svg transform="translate(15)" width="17%" height="12%" viewBox="0 0 44 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="60%" y="50%" textAnchor="middle" fill="#FFFFFF" fontSize="90%" fontFamily="Montserrat" dy=".3em" fontWeight="bold">{text}</text>      </svg>
    )
  }
  return (
