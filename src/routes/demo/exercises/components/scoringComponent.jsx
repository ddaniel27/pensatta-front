...
export default function ScoringComponent({initMessages=["Inicia dando click al boton"], title="Actividad", children, background="#E0E0E0", threshold={perfect: 1, max: 1, min: 1}, exerciseId = 0, dim=1, apr=1}){

    const { setActivity, setTitle, setBackground, setExercises } = React.useContext(ActivityContext)
