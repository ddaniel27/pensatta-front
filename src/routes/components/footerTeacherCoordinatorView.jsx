...
export default function FooterTeacherCoordinatorView ({ downloadPDF = true, coordinator = true }) {
  const { setPhase } = useContext(CoordinatorContext)

  return (
    <div className='FooterTeacherCoordinatorView'>
      {downloadPDF ? <div className='FooterTeacherCoordinatorView__informe'>DESCARGAR INFORME DEL CURSO</div> : <div />}
