...
import { coordinacionMetricsStudents } from '../../../requests'

export default function DashboardRows ({ title = 'Grado', grade = '6 A', average = 5, data = defaultData, userId }) {
  ...
  useEffect(() => {
    coordinacionMetricsStudents(userId, ctx_hB_r_sI.gradoId, (response) => {
