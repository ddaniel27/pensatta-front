    ...
    <div className='institution-screen'>
      ...
      <div className='institution-info'>
        <div className='editable-info'>
          ...
          <p>{t('language')}{institutionList[currInst]?.language && <span>{institutionList[currInst]?.language} <i className='fas fa-edit' onClick={() => { handleShowModal({ institution: institutionList[currInst]?.id, field: t('language') }) }} /></span>}</p>
        </div>
